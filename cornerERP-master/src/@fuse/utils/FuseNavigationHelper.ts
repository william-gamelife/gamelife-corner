...
class FuseNavigationHelper {
	...
	static filterNavigationByPermission(nav: FuseNavItemType[], userRole: User['roles']): FuseNavItemType[] {
	...
	static hasPermission(authArr: string[] | string | undefined, userRole: User['roles']): boolean {
		/**
